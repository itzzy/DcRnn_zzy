...
# nohup python main_crnn_test_zzy.py --acceleration_factor 4 > output_0112_2.log 2>&1 &
if __name__ == '__main__':
    ...
    # Project config
    model_name = 'crnn_mri_0226_kspace_center_1'
    ...
    scaler = torch.cuda.amp.GradScaler(enabled=True)  # 移除了 'cuda' 参数
    ...
    for epoch in range(num_epoch):
        ...
        for batch_idx, im in enumerate(iterate_minibatch(train, batch_size, shuffle=True)):
            ...
            # print('im_undersample-shape:',im_undersample.shape) #im_undersample-shape: torch.Size([1, 2, 256, 256, 30])
            # print('im_undersample-dtype:',im_undersample.dtype) #im_undersample-dtype: torch.float32
            # print('k_undersample-shape:',k_undersample.shape) #k_undersample-shape: torch.Size([1, 2, 256, 256, 30])
            # print('k_undersample-dtype:',k_undersample.dtype) #k_undersample-dtype: torch.float32
            # print('mask-shape:',mask.shape) #mask-shape: torch.Size([1, 2, 256, 256, 30])
            # print('mask-dtype:',mask.dtype) #mask-dtype: torch.float32
            # print('groudtruth-shape:',groudtruth.shape) #groudtruth-shape: torch.Size([1, 2, 256, 256, 30])
            # print('groudtruth-dtype:',groudtruth.dtype) #groudtruth-dtype: torch.float32
